 ...
 *
 * Fork of https://github.com/cloudyourcar/minmea
 *
 * Changes:
 *
 * - checksum strict mode modified
 */
...
bool minmea_check(const char *sentence, bool strict)
{
    ...
    if (*sentence == '*') {
        ...
        // Discard non-checksummed frames.
        return false;
    }

    // The only stuff allowed at this point is a newline in strict mode
